...
<head>
    ...
    <title>Audiences — PulseMail Enterprise</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="audience.php" class="sidebar-link active"><i class="bi bi-people"></i> Audiences & Lists</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Customer Audiences & Segments</h1>
            <button class="btn btn-sm btn-primary"><i class="bi bi-person-plus me-1"></i> Add Subscriber</button>
        </header>
        ...
        <div class="p-4">
            <div class="card border-0 shadow-sm overflow-hidden">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td class="fw-semibold">Alex Morgan</td>
                            <td>alex.morgan@apexcorp.internal</td>
                            <td><span class="badge bg-primary bg-opacity-10 text-primary">VIP Executive</span></td>
                            <td>98 / 100</td>
                            <td><span class="badge bg-success">Subscribed</span></td>
                        </tr>
                        <tr>
                            <td class="fw-semibold">Sarah Jenkins</td>
                            <td>s.jenkins@cloudnet.org</td>
                            <td><span class="badge bg-info bg-opacity-10 text-info">Enterprise</span></td>
                            <td>85 / 100</td>
                            <td><span class="badge bg-success">Subscribed</span></td>
                        </tr>
                        <tr>
                            <td class="fw-semibold">David Vance</td>
                            <td>david.vance@techcorp.io</td>
                            <td><span class="badge bg-secondary bg-opacity-10 text-secondary">Standard</span></td>
                            <td>72 / 100</td>
                            <td><span class="badge bg-success">Subscribed</span></td>
                        </tr>
                    </tbody>
