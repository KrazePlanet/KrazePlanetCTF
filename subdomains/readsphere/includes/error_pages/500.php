 ...
 * Page 500
 * 
 * Cette page est affichée lorsqu'une erreur serveur se produit.
...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <!-- Titre -->
        <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl">500</h1>
        <h2 class="mt-2 text-2xl font-bold text-gray-900">Erreur serveur</h2>
        ...
        <!-- Bouton de retour -->
        <div class="mt-8">
            <a href="<?php echo function_exists('url') ? url('/') : '/'; ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
...
<body>
    <div class="error-container">
        ...
        <p>Une erreur inattendue s'est produite. Notre équipe a été notifiée et travaille à résoudre le problème.</p>
        <p>Veuillez réessayer dans quelques instants ou revenir à la page d'accueil.</p>
