...
// Extract current URL path unencoded to trigger Path-based XSS
$raw_uri = $_SERVER['REQUEST_URI'] ?? '/path-fetch/';
$path = urldecode(parse_url($raw_uri, PHP_URL_PATH) ?? '');
?>
...
<head>
  ...
  <title>Reflected XSS - Path Based</title>
...
<body>
  <nav class="navbar navbar-expand-md navbar-dark sticky-top">
    ...
    <div class="container text-center">
      <h1 class="hero-title">Reflected XSS - Path Based</h1>
      <p class="hero-subtitle">Test for reflected XSS vulnerabilities through the URL path</p>
