...
<head>
    ...
    <title>Krables Market — Fresh Grocery Store</title>
...
<body>
    ...
    <header class="header">
        <div class="top-header">
            <div class="th">
                ...
                <div class="selecloc">
                    <div class="dropdown" tabindex="0" onclick="show_location()" style="cursor:pointer">
                        <div class="text">
                    ...
                    <div class="location fadeup" id="lcnpnl">
                        ...
                        <ul>
                            ...
                            <li>
                                <i class="uil uil-location-point"></i>
                                <a href="index.php?utm_source=<?php echo $row['id']; ?>" class="lcn-search"><?php echo $row['city_name']; ?></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                <div class="search">
                    <div class="cat" onclick="show_cat()" style="cursor:pointer">
                        <i class="uil uil-apps"></i>
                        <i class="uil uil-angle-down icon__14"></i>
                    </div>
                    <form action="view.php" method="GET">
                ...
                <div class="rightbox">
                    <ul>
                        <li>
                            <a href="tel:18000000000" class="rightlink">
                        ...
                        <li class="user">
                            <a href="javascript:void(0)" class="rightlink" onclick="show_userpanel()">
                                <i class="uil uil-user-circle bg"></i>
                            </a>
                            <div class="userpanel fadeup" id="userpanel">
                                <ul>
                                    <li><i class="uil uil-chat-bubble-user"></i><a href="myac.php">My Account</a></li>
                                    <li><i class="uil uil-box"></i><a href="myac.php">My Orders</a></li>
                                    <li><i class="uil uil-heart-alt"></i><a href="wishlist.php">My Wishlist</a></li>
                                    <li><i class="uil uil-shopping-cart"></i><a href="cart.php">My Cart</a></li>
                                    <li><i class="uil uil-wallet"></i><a href="myac.php">My Wallet</a></li>
                                    <li><i class="uil uil-map-marker-alt"></i><a href="add_address.php">My Address</a></li>
                                    <?php if(isset($_SESSION['USER_LOGIN'])){ ?>
                                    <li onclick="logout()"><i class="uil uil-signout"></i><a href="javascript:void(0)">Logout</a></li>
                                    <?php } else { ?>
                                    <li><i class="uil uil-signin"></i><a href="auth/v2/">Login</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="bottom-header">
            <div class="sub-header">
                <div class="hamberger" onclick="sidebar()" style="cursor:pointer">
                ...
                <nav>
                    ...
                    ?>
                    <div class="div">
                        <a href="view.php?n=<?php echo $row['id'] ?>&k="><?php echo $row['category']; ?></a>
                        <i class="uil uil-angle-down icon__14"></i>
                        <div class="userpanel fadeup">
                            <ul>
                                <?php 
                                $cid=$row['id'];
                ...
                <div class="cart-right" onclick="control.redirect('cart.php')" style="cursor:pointer">
                    <i class="uil uil-shopping-cart-alt"></i>Cart
                </div>
                <div class="srch" onclick="openrss()" style="cursor:pointer">
                    <i class="uil uil-search"></i>
                </div>
            </div>
        </div>
    ...
    <div class="slider" id="sidebar">
        <ul>
            <li class="flex flex-center"><a href="index.php"> Home </a></li>
            <?php
            $res=mysqli_query($con,"select * from categories limit 10");
            while($row=mysqli_fetch_assoc($res)){
            ?>
