...
<?php
    ...
    if(isset($_POST['admin_login']))
    {
      ...
      $a_pwd=($_POST['a_pwd']);//
      $stmt=$mysqli->prepare("SELECT email, password, id FROM admin WHERE email=? and password=? ");//sql to log in user
...
<head>
  ...
  <title>coworking Booking System - Admin Login</title>
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <a class="d-block small mt-3" href="../home.php">Home Page</a>
