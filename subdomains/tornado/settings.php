...
<head>
    <meta charset="UTF-8">
    <title>Engine Settings — TornadoAlert</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="nodes.php" class="sidebar-link"><i class="bi bi-hdd-network"></i> Edge Nodes</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Tornado Engine Configuration</h1>
        </header>

        <div class="p-4">
            <div class="card p-4 border border-secondary border-opacity-25 bg-dark text-white shadow-sm mb-4">
                <h6 class="fw-bold mb-3">Template Processing Backend</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Framework</label>
                        <input type="text" class="form-control form-control-sm bg-black text-white border-secondary" value="Tornado 6.4.0 (Python 3.12)" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Execution Mode</label>
                        <input type="text" class="form-control form-control-sm bg-black text-white border-secondary" value="Direct In-Memory AST Compilation" readonly>
                    </div>
                </div>
            </div>
        </div>
