...
<head>
    <meta charset="UTF-8">
    <title>Telemetry — TornadoAlert</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="metrics.php" class="sidebar-link active"><i class="bi bi-speedometer2"></i> Telemetry & Metrics</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Cluster Telemetry & Performance</h1>
        </header>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">Global P99 Latency</div>
                        <div class="fs-4 fw-bold text-danger">142.5ms</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">Ingress Throughput</div>
                        <div class="fs-4 fw-bold text-info">2.14M req/s</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">Error Rate</div>
                        <div class="fs-4 fw-bold text-warning">4.12%</div>
                    </div>
                </div>
            </div>
        </div>
