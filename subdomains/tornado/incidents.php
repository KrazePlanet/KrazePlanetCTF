...
<head>
    <meta charset="UTF-8">
    <title>Active Incidents — TornadoAlert</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="incidents.php" class="sidebar-link active"><i class="bi bi-activity"></i> Active Incidents</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Active Incident Stream</h1>
            <a href="index.php" class="btn btn-sm btn-info text-white"><i class="bi bi-plus-lg me-1"></i> Edit Alert Template</a>
        </header>
        ...
        <div class="p-4">
            <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white mb-3 shadow-sm">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <span class="badge bg-danger">SEV-1 Critical</span>
                        <h5 class="fw-bold mt-2 mb-1">Edge Proxy Ingress Connection Pool Saturation</h5>
                        <div class="text-muted small">Incident: <code>INC-2026-8942</code> &bull; Node: <code>edge-gw-08.us-east.prod</code> (us-east-1)</div>
                    </div>
                    <a href="index.php" class="btn btn-sm btn-outline-info">View Notification</a>
                </div>
            </div>
        </div>
    </main>
