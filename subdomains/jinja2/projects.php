...
<head>
    <meta charset="UTF-8">
    <title>Projects — CloudGuard</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="projects.php" class="sidebar-link active"><i class="bi bi-folder-check"></i> Scanned Projects</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Active Cloud Infrastructure Projects</h1>
            <a href="index.php" class="btn btn-sm btn-success text-dark fw-bold"><i class="bi bi-plus-lg me-1"></i> Edit Report Template</a>
        </header>
        ...
        <div class="p-4">
            <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white mb-3 shadow-sm">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <span class="badge bg-success">SOC2 Type II Certified</span>
                        <h5 class="fw-bold mt-2 mb-1">CloudGuard Compliance Auditing Platform</h5>
                        <div class="text-muted small">Project: <code>PRJ-2026-904</code> &bull; AWS us-west-2 &bull; Score: 98.5%</div>
                    </div>
                    <a href="index.php" class="btn btn-sm btn-outline-success">View Report</a>
                </div>
            </div>
        </div>
    </main>
