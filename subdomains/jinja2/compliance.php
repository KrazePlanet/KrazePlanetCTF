...
<head>
    <meta charset="UTF-8">
    <title>Badges & Credentials — DevSpace</title>
    ...
    <style>
        ...
        .badge-box { background: #0d1527; border: 1px solid #1e293b; border-radius: 12px; padding: 24px; text-align: center; }
    </style>
</head>
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="compliance.php" class="sidebar-link active"><i class="bi bi-award"></i> Badges & Credentials</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Verified Badges & Credentials</h1>
        ...
        <div class="p-4" style="max-width: 900px;">
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="badge-box">
                        <i class="bi bi-patch-check-fill text-info fs-1 mb-2"></i>
                        <h6 class="fw-bold text-white mb-1">Staff Contributor</h6>
                        <p class="text-secondary small mb-0">Top 1% technical open-source maintainer across cloud security repositories.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="badge-box">
                        <i class="bi bi-shield-check text-success fs-1 mb-2"></i>
                        <h6 class="fw-bold text-white mb-1">Cloud Architect Pro</h6>
                        <p class="text-secondary small mb-0">Certified multi-cloud Kubernetes resilience & isolation specialist.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="badge-box">
                        <i class="bi bi-lightning-charge-fill text-warning fs-1 mb-2"></i>
                        <h6 class="fw-bold text-white mb-1">Bug Hunter Elite</h6>
                        <p class="text-secondary small mb-0">Recognized for responsibly reporting critical server vulnerabilities.</p>
                    </div>
                </div>
            </div>
        </div>
