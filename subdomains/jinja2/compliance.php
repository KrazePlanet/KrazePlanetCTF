...
<head>
    <meta charset="UTF-8">
    <title>Compliance — CloudGuard</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="compliance.php" class="sidebar-link active"><i class="bi bi-patch-check"></i> Compliance Badges</a>
            <a href="findings.php" class="sidebar-link"><i class="bi bi-bug"></i> Posture Findings</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Compliance Framework Badges</h1>
        </header>

        <div class="p-4">
            <div class="row g-3">
                <div class="col-md-3">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">SOC2 Type II</div>
                        <div class="fs-4 fw-bold text-success">100% Compliant</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">ISO 27001</div>
                        <div class="fs-4 fw-bold text-success">98.2% Compliant</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">HIPAA Security</div>
                        <div class="fs-4 fw-bold text-info">Audited</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card p-3 border border-secondary border-opacity-25 bg-dark text-white shadow-sm">
                        <div class="text-muted small">PCI-DSS 4.0</div>
                        <div class="fs-4 fw-bold text-success">Ready</div>
                    </div>
                </div>
            </div>
        </div>
