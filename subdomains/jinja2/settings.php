...
<head>
    <meta charset="UTF-8">
    <title>Engine Settings — CloudGuard</title>
...
<body>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Jinja2 Template Engine Settings</h1>
        </header>
        ...
        <div class="p-4">
            <div class="card p-4 border border-secondary border-opacity-25 bg-dark text-white shadow-sm mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Renderer</label>
                        <input type="text" class="form-control form-control-sm bg-black text-white border-secondary" value="Python Jinja2 (v3.1.2)" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Autoescaping</label>
                        <input type="text" class="form-control form-control-sm bg-black text-white border-secondary" value="Enabled (HTML & XML Contexts)" readonly>
                    </div>
                </div>
            </div>
        </div>
