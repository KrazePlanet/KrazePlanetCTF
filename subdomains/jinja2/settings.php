...
<head>
    <meta charset="UTF-8">
    <title>Account Security & Settings — DevSpace</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="projects.php" class="sidebar-link"><i class="bi bi-code-slash"></i> Public Repositories</a>
            ...
            <a href="settings.php" class="sidebar-link active"><i class="bi bi-gear-wide-connected"></i> Account Security</a>
        </div>
    </aside>

    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Account & Security Preferences</h1>
        ...
        <div class="p-4" style="max-width: 800px;">
            <div class="card bg-dark border-secondary p-4 mb-4">
                <h5 class="fw-bold text-white mb-3">Two-Factor Authentication</h5>
                <p class="text-secondary small">Secure your DevSpace developer account using WebAuthn or TOTP authenticator app.</p>
                <div class="d-flex align-items-center gap-2">
                    <span class="badge bg-success bg-opacity-25 text-success border border-success border-opacity-50">Enabled (YubiKey 5C)</span>
                </div>
            </div>

            <div class="card bg-dark border-secondary p-4">
                <h5 class="fw-bold text-white mb-3">Template Engine Sanitization Policy</h5>
                <p class="text-secondary small">Status message and biography dynamic expressions are currently evaluated using standard Jinja2 Environment.</p>
                <div class="alert alert-warning small mb-0">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i> Security Notice: User personalization strings must be properly sandboxed or escaped to prevent Server-Side Template Injection.
                </div>
            </div>
        </div>
    </main>
