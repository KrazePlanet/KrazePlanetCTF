...
<head>
    ...
    <title>Admin login — Enigma Event Management</title>
    <meta charset="UTF-8">
    ...
    * {
    ...
    .loginbackground-gridContainer {
        ...
        -ms-grid-rows: [top] 1fr [top-gutter] (64px)[8] [bottom-gutter] 1fr [end];
        grid-template-rows: [top] 1fr [top-gutter] repeat(8, 64px) [bottom-gutter] 1fr [end];
        justify-content: center;
        margin: 0 -2%;
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                ...
                <div class="formbg-outer">
                        ...
                        <div class="formbg-inner padding-horizontal--48">
                            ...
                            <form id="stripe-login" method="POST" action="login.php">
                                <div class="field padding-bottom--24">
                                    ...
                                    <input type="email" name="username" value="admin@enigma.com" required>
                                </div>
                                <div class="field padding-bottom--24">
                    ...
                    <div class="footer-link padding-top--24">
                        <span>Credentials: <strong>admin@enigma.com</strong> / <strong>admin</strong></span>
                    </div>
                </div>
            </div>
        </div>
