...
<head>
    <meta charset="UTF-8">
    <title>Engine Settings — DocuCraft</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="invoices.php" class="sidebar-link"><i class="bi bi-journal-text"></i> Invoices & Bills</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Ruby ERB Engine Configuration</h1>
        </header>

        <div class="p-4">
            <div class="card p-4 border-0 shadow-sm mb-4">
                <h6 class="fw-bold mb-3">Template Renderer Engine</h6>
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Renderer</label>
                        <input type="text" class="form-control form-control-sm" value="Ruby Standard Library (ERB)" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Trim Mode</label>
                        <input type="text" class="form-control form-control-sm" value="trim_mode: '-'" readonly>
                    </div>
                </div>
            </div>
        </div>
