...
<head>
    <meta charset="UTF-8">
    <title>Organizations — DocuCraft</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="customers.php" class="sidebar-link active"><i class="bi bi-buildings"></i> Organizations</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Enterprise Accounts & Organizations</h1>
        </header>
        ...
        <div class="p-4">
            <div class="card p-3 border-0 shadow-sm mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fw-bold mb-1">Apex Global Enterprise</h6>
                        <div class="text-muted small">Account: <code>ACC-892301</code> &bull; Primary Contact: Marcus Vance (marcus.vance@rubycorp.internal)</div>
                    </div>
                    <span class="badge bg-success">Tier 1 Dedicated</span>
                </div>
            </div>
        </div>
    </main>
