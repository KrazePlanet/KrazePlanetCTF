...
<head>
    <meta charset="UTF-8">
    <title>Infrastructure — DocuCraft</title>
...
<body>
    <aside class="app-sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="servers.php" class="sidebar-link active"><i class="bi bi-hdd-stack"></i> Infrastructure</a>
    ...
    <main class="app-workspace">
        <header class="app-topbar">
            <h1 class="fs-5 fw-bold mb-0">Ruby Application Nodes & Clusters</h1>
        </header>
        ...
        <div class="p-4">
            <div class="card p-3 border-0 shadow-sm mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fw-bold mb-1"><i class="bi bi-hdd-network text-success me-2"></i> Cluster Node us-west-01</h6>
                        <div class="text-muted small">Ruby 3.2.3 &bull; ERB Engine Active &bull; Load: 0.12, 0.08, 0.04</div>
                    </div>
